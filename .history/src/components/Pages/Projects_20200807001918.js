        ...
        <div className='cards-container'>
          <div className='card' style={{ margin: '70px auto' }}>
            ...
            <div className='card-footer'>
              ...
              <a
                href='https://hopeful-bhaskara-50c3c0.netlify.app/'
          ...
          <div className='card' style={{ margin: '70px auto' }}>
            ...
            ></div>
            <div className='card-footer'>
              <span className='work-name'>Instagram clone</span>
              <span className='work-description'>
                Uploads images, allows user to comment.I built using react
              </span>
              <a
                href='https://instagram-54367.web.app/'
                className='btn-learn-more'
                target='_blank'
                rel='noopener noreferrer'
              >
          ...
          <div className='card' style={{ margin: '70px auto' }}>
            ...
            <div className='card-footer'>
              ...
              <span className='work-description'>
                allows users to communicate in a group chat .
              </span>
              <a
