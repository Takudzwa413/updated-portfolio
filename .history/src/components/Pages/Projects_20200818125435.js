        ...
        <div className='cards-container'>
          ...
          <div className='card' style={{ margin: '70px auto' }}>
            <div
              ...
              style={{
                backgroundImage:
                  'linear-gradient(-225deg, rgba(0,101,168,0.0) 0%, rgba(0,36,61,0.0) 50%), url("https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.illinoislottery.com%2Fdbg%2Fhow-to-play%2Fpowerball&psig=AOvVaw0mBOVy_NTjHWTqA60rLTCJ&ust=1597834374581000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCOip9YrLpOsCFQAAAAAdAAAAABAD")',
              }}
            ></div>
            <div className='card-footer'>
              <span className='work-name'>Github Finder</span>
